...
CTE.commandExportHandlerPrefix = function(command) {
	...
	if (command.code == 111) { // Conditional Branch: Include notable conditions that involve select switches/variables
		...
		if (conditionType == 0) { // Switch
			...
			var statusNames = [ "Sara", "Joe", "Keiji", "Kanna", "Q-taro", "Sou", "Reko", "Nao", "Kai", "Gin", "Mishima", "Gonbee" ];
			...
			if (notableVariables.includes(variableId)) {
				...
				if (parseInt(command.parameters[2]) != 0) { // Variable reference
					...
					if (variableId >= 481 && variableId <= 492 && rightSide == 3) rightSide += " (" + statusNames[variableId - 481] + " is dead)";
				}
	...
	switch (characterID) {
		case 0:
			...
			switch (expressionID) {
				...
				case 7: expression = "Tired eyes, closed-eyes smile"; break;
				case 8: expression = "Tired eyes, slight frown"; break;
				case 10: expression = "Evil grin"; break;
				case 12: expression = "Flushed-red face, sweatdrop"; break;
				...
				case 24: expression = "Hands on hips, flushed-red face, sweatdrop"; break;
				...
				case 36: expression = "Grown up, smile"; break;
				case 37: expression = "Grown up, surprise"; break;
				case 38: expression = "Grown up, smug smile"; break;
				case 39: expression = "Grown up, closed-eyes smile"; break;
		...
		case 2:
			...
			switch (expressionID) {
				...
				case 38: expression = "Back turned, mushroom growing from shoulder"; break;
				case 99: expression = "Hallucination"; break;
			}
			break;
		...
		case 3:
			...
			switch (expressionID) {
				...
				case 32: expression = "Pudding on head"; break;
				case 99: expression = "Hallucination"; break;
			}
			break;
		...
		case 4:
			...
			switch (expressionID) {
				...
				case 26: expression = "Slim, default"; break;
				case 27: expression = "Slim, mouth open"; break;
				case 28: expression = "Slim, eyes closed"; break;
				case 29: expression = "Slim, smile"; break;
				case 30: expression = "Slim, pained look"; break;
				case 99: expression = "Hallucination"; break;
			}
			break;
		...
		case 7:
			...
			switch (expressionID) {
				...
				case 29: expression = "Wide eyes, flushed-red face"; break;
				case 30: expression = "Holding wrist, mouth open happily"; break;
				case 31: expression = "Teacher, neutral smile"; break;
				case 32: expression = "Teacher, mouth open"; break;
				case 33: expression = "Teacher, eyes-closed smile"; break;
				case 34: expression = "Teacher, tears welling"; break;
				case 35: expression = "Teacher, eyes closed sadly"; break;
				case 36: expression = "Teacher, happy with tears"; break;
				case 99: expression = "Hallucination"; break;
			}
			break;
		...
		case 8:
			...
			switch (expressionID) {
				...
				case 23: expression = "Hallucination (blacked-out face)"; break;
		...
		case 12:
			...
			switch (expressionID) {
				...
				case 8: expression = "Upturned eyebrows, sweatdrop"; break;
				case 9: expression = "Raised-eyebrows smile"; break;
				case 10: expression = "Open-mouth smile"; break;
				case 11: expression = "Open-mouth smile with raised eyebrows"; break;
				case 12: expression = "Serious face"; break;
				case 13: expression = "Hand on chin, grin"; break;
				case 14: expression = "Hand on chin, mouth open"; break;
				case 15: expression = "Hand on chin, upturned eyebrows, sweatdrop"; break;
				case 16: expression = "Hand on chin, raised-eyebrows smile"; break;
				case 17: expression = "Hand on chin, open-mouth smile"; break;
				case 18: expression = "Hand on chin, raised-eyebrows open-mouth smile"; break;
				case 19: expression = "Hand on chin, serious face"; break;
				case 20: expression = "Adjusting glasses, frown"; break;
				case 21: expression = "Adjusting glasses, happy grin"; break;
				case 22: expression = "Adjusting glasses, devious grin"; break;
				case 23: expression = "Adjusting glasses, frown with sweatdrop"; break;
				case 24: expression = "Standing proud, frown"; break;
				case 25: expression = "Standing proud, happy grin"; break;
				case 26: expression = "Standing proud, devious grin"; break;
				case 27: expression = "Standing proud, frown with sweatdrop"; break;
				case 28: expression = "Gripping chest and head, despairing"; break;
				case 29: expression = "Gripping chest and head, angry eyes"; break;
				case 30: expression = "Gripping chest and head, despairing, sweat"; break;
				case 31: expression = "Gripping chest and head, angry eyes, sweat"; break;
				case 32: expression = "Gripping chest and head, despairing, grim look"; break;
				case 33: expression = "Gripping chest and head, angry eyes, grim look"; break;
				case 34: expression = "Adjusting glasses, devious grin, grim look"; break;
				case 99: expression = "Hallucination"; break;
			}
			break;
		...
		case 17:
			character = "サラの父";
			switch (expressionID) {
				case 11: expression = "Plain clothes, default smile"; break;
				case 12: expression = "Plain clothes, toothy grin"; break;
				case 13: expression = "Plain clothes, neutral"; break;
			}
			break;
		...
		case 91:
			...
			switch (expressionID) {
				...
				case 49: expression = "Looking down in despair, face obscured"; break;
			}
			break;
		...
		case 93:
			...
			switch (expressionID) {
				...
				case 15: expression = "Pouting face, eyes looking to side"; break;
			}
			break;
		...
		case 94:
			...
			switch (expressionID) {
				...
				case 22: expression = "Smile"; break;
				case 23: expression = "Holding glasses across chest, smile"; break;
			}
			break;
		...
		case 96:
			...
			switch (expressionID) {
				...
				case 15: expression = "Closed-eyes smile"; break;
			}
			break;
		...
		case 97:
			...
			switch (expressionID) {
				case 1: expression = "Default frown"; break;
				case 2: expression = "Mouth open"; break;
				case 3: expression = "Doubting look"; break;
				case 4: expression = "Doubting look, closed teeth, sweat"; break;
				case 5: expression = "Doubting look, mouth open"; break;
				case 6: expression = "Doubting look, closed teeth"; break;
				case 7: expression = "Eyes fully open, smile"; break;
				case 8: expression = "Closed-eyes smile"; break;
			}
			break;
		...
		case 98:
			character = "ジン";
			switch (expressionID) {
				case 1: expression = "Neutral"; break;
				case 2: expression = "Mouth open"; break;
				case 3: expression = "Smile"; break;
				case 4: expression = "Clenched teeth, sweat"; break;
				case 7: expression = "Malnourished, neutral"; break;
				case 8: expression = "Malnourished, mouth open"; break;
				case 9: expression = "Malnourished, clenched teeth"; break;
			}
			break;
...
Sprite_Picture.prototype._processText = function(bitmap) {
	...
	text = CTE.replaceStringsInDText(text);
...
CTE.replaceStringsInDText = function(text) {
	if (!ConfigManager.isBaseLanguage()) {
		text = text.replace(/(\d+) 日目/g, CTE.getString("DText_$1 日目", "$1 日目"));
		text = text.replace(/(\d+) 個/g, CTE.getString("DText_$1 個", "$1 個"));
		text = text.replace(/(\d+) 円/g, CTE.getString("DText_$1 円", "$1 円"));
	}
	return text;
};

// Internally convert localized game titles (i.e. "Your Time To Shine") to Japanese title for compatibility with pre-CTE saves.
CTE.DataManager_loadGlobalInfo = DataManager.loadGlobalInfo;
DataManager.loadGlobalInfo = function() {
	var localizedNames = [ "Your Time To Shine", "Kimi ga Shine -Island Existence-" ];
...
// Upon loading a save, always reset original and localized values of HUD text.
...
DataManager.loadGameWithoutRescue = function(savefileId) {
	...
	if (result) {
		if (typeof $gameScreen._pictures[6] !== "undefined" && $gameScreen._pictures[6] != null && typeof $gameScreen._pictures[6].dTextInfo !== "undefined") {
			$gameScreen._pictures[6].dTextInfo.originalValue = "\\C[6]\\oc[c]\\V[453] 日目\n";
			$gameScreen._pictures[7].dTextInfo.originalValue = "\\C[6]\\oc[c]\\I[27]\\V[454]\n\\C[6]\\oc[c]\\I[28]\\V[455] 個\n\\C[6]\\oc[c]\\I[29]\\V[456] 個\n\\C[6]\\oc[c]\\I[30]\\V[457] 円\n";
			$gameScreen._pictures[6].dTextInfo.value = CTE.replaceStringsInDText($gameScreen._pictures[6].dTextInfo.originalValue);
			$gameScreen._pictures[7].dTextInfo.value = CTE.replaceStringsInDText($gameScreen._pictures[7].dTextInfo.originalValue);
			$gameVariables._changedVariables.push(453);
			$gameVariables._changedVariables.push(454);
		}
	}
	return result;
};
